clips = {
	[1] = {'T','You can use science to distinguish between humans and shapeshifters, so they must oppose science and the scientific method.'},
	[2] = {'T','I don’t understand how he was invited into our group in the first place, forget shapeshifting, the guy can barely talk.'},
	...
	[6] = {'T','What kind of question is this? Is this a job interview? Well I’m a team player and my main weakness is perfectionism'},
	[7] = {'T','Duh!'},
	[8] = {'T','What evidence do you have to support that?'},
	[9] = {'T','You’ve made a good argument here, he’s consistently undermining every logical discussion we have with his spiritual gobbledigook.'},
	[10] = {'T','Hmm, you’re right, if a shapeshifter came here I’m the logical pick. I can’t see how he could decide to impersonate anyone else in this room. Yeah, I must be the shapeshifter.'},
	[11] = {'T','Bobby, It can only be Bobby'},
	[12] = {'T','As you said, I’m the only logical choice here, it just has to be me'},
	[13] = {'T','You’ve managed to convince me, Mike’s unscientific behaviour proves he’s the shapeshifter beyond any reasonable doubt.'},
	[14] = {'T','I’m not!'},
	[15] = {'T','Stop this!'},
	[16] = {'T','This is slander!'},
	[17] = {'T','This makes no sense at all'},[18] = {'T','shapeshifters are non-human creatures that take human form, using empirical evidence it must be possible to distinguish between the two'},
	...
	[24] = {'M','Well, aren’t we all shapeshifters? People don’t show what’s inside they go around wearing masks'},
	...
	[28] = {'M','Weird stuff, man, the entire world seems like there’s no free will, that it’s not me talking, someone else’s words coming out from my mouth. Is that how you feel when you’re a shapeshifter? This is scary, man.'},
	[29] = {'M','If that is your truth, that’s enough for me'},
	[30] = {'M','You’re absolutely right man, I feel so hard communicating with him, bobby what’s your truth man'},
	[31] = {'M','A shapeshifter took Bobby’s truth from him, man.'},
	[32] = {'M','Why would you say such a thing?'},
	[33] = {'M','I so get what you mean, all these attempts to hide what’s really inside. Open up Tommy, let us see the real Shapeshifter in you'},
	[34] = {'M','Well, man the only Shapeshifter I know is me, but aren’t we all shapeshifters? I mean listen guys, isn’t it the same voice talking through all of us?'},
	...
	[76] = {'A','It is estimated that one in four is a dangerous shapeshifter, the public is encouraged to stay vigilant against this vicious enemy.'},
	[77] = {'A','If there are more than 3 people in your room, one of them may be a shapeshifter, maybe it’s Tommy.'},
